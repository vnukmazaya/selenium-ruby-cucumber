...
public class FirstTest {
    ...
    public void openpage() {
        ...
        //Выбрать производителей Apple и Samsung
        driver.findElement(By.xpath("//label[@for='glf-7893318-153043']")).click();
        ...
        if (sumel1 != 12) {
            ...
            System.out.println(sumel1+"Телефонов найдено)");
        }
        else {
            System.out.println(sumel1+"Телефонов найдено)");
        }
        // Запомнить первый элемент в списке, найти и проверить, что наименование товара соответствует запомненному
